...
lazy val slickCodeGenTask = Def.task {
  ...
  val url = "jdbc:mysql://localhost/mindlevel?nullNamePatternMatchesAll=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC"
