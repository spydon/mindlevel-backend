...
trait Tables {
  ...
  case class AccomplishmentRow(id: Int, title: String, description: String, image: String, challengeId: Int, score: Int = 0, created: Option[Long] = None)
  ...
  implicit def GetResultAccomplishmentRow(implicit e0: GR[Int], e1: GR[String], e2: GR[Option[Long]]): GR[AccomplishmentRow] = GR{
    prs => import prs._
    AccomplishmentRow.tupled((<<[Int], <<[String], <<[String], <<[String], <<[Int], <<[Int], <<?[Long]))
  }
  ...
  class Accomplishment(_tableTag: Tag) extends profile.api.Table[AccomplishmentRow](_tableTag, None, "accomplishment") {
    def * = (id, title, description, image, challengeId, score, created) <> (AccomplishmentRow.tupled, AccomplishmentRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(title), Rep.Some(description), Rep.Some(image), Rep.Some(challengeId), Rep.Some(score), created).shaped.<>({r=>import r._; _1.map(_=> AccomplishmentRow.tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6.get, _7)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
  ...
  case class ChallengeRow(id: Int, title: String, description: String, image: String, created: Long = 0L, creator: String, validated: Boolean)
  ...
  implicit def GetResultChallengeRow(implicit e0: GR[Int], e1: GR[String], e2: GR[Long], e3: GR[Boolean]): GR[ChallengeRow] = GR{
    prs => import prs._
    ChallengeRow.tupled((<<[Int], <<[String], <<[String], <<[String], <<[Long], <<[String], <<[Boolean]))
  }
  ...
  class Challenge(_tableTag: Tag) extends profile.api.Table[ChallengeRow](_tableTag, None, "challenge") {
    def * = (id, title, description, image, created, creator, validated) <> (ChallengeRow.tupled, ChallengeRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(title), Rep.Some(description), Rep.Some(image), Rep.Some(created), Rep.Some(creator), Rep.Some(validated)).shaped.<>({r=>import r._; _1.map(_=> ChallengeRow.tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6.get, _7.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
  ...
  case class UserRow(username: String, description: Option[String] = None, image: Option[String] = Some("user.jpg"), score: Int, created: Long, lastActive: Option[Long] = None)
  ...
  implicit def GetResultUserRow(implicit e0: GR[String], e1: GR[Option[String]], e2: GR[Int], e3: GR[Long], e4: GR[Option[Long]]): GR[UserRow] = GR{
    prs => import prs._
    UserRow.tupled((<<[String], <<?[String], <<?[String], <<[Int], <<[Long], <<?[Long]))
  }
  /** Table description of table user. Objects of this class serve as prototypes for rows in queries. */
  class User(_tableTag: Tag) extends profile.api.Table[UserRow](_tableTag, None, "user") {
    def * = (username, description, image, score, created, lastActive) <> (UserRow.tupled, UserRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(username), description, image, Rep.Some(score), Rep.Some(created), lastActive).shaped.<>({r=>import r._; _1.map(_=> UserRow.tupled((_1.get, _2, _3, _4.get, _5.get, _6)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
