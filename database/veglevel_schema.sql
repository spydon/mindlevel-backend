...
-- -----------------------------------------------------
-- Table `veglevel`.`notification`
-- -----------------------------------------------------

CREATE TABLE IF NOT EXISTS `veglevel`.`notification` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `title` VARCHAR(191) NOT NULL,
  `description` VARCHAR(1024) NOT NULL,
  ...
  CONSTRAINT `fk_notification_target`
    ...
    REFERENCES `veglevel`.`notification_target` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

-- -----------------------------------------------------
-- Table `veglevel`.`notification_user`
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `veglevel`.`notification_user` (
  ...
  CONSTRAINT `fk_notification_user_1`
    ...
    REFERENCES `veglevel`.`notification` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `veglevel`.`notification_target`
-- -----------------------------------------------------

CREATE TABLE IF NOT EXISTS `veglevel`.`notification_target` (
  `id` INT NOT NULL,
  `name` VARCHAR(191) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `veglevel`.`comment`
-- -----------------------------------------------------

CREATE TABLE IF NOT EXISTS `veglevel`.`comment` (
  `id` INT NOT NULL AUTO_INCREMENT,
