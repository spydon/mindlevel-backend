...
output "mindlevel_vpc_id" {
  value = "${aws_vpc.mindlevel_vpc.id}"
}

output "mindlevel_public_sn_01_id" {
  value = "${aws_subnet.mindlevel_public_sn_01.id}"
}

output "mindlevel_public_sg_id" {
  value = "${aws_security_group.mindlevel_public_sg.id}"
}
